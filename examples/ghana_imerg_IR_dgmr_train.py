...
from servir.datasets.dataLoader_ghana_imerg_IR_h5 import ghanaImergIRDataModule
...
def main():
    ...
    data_module = ghanaImergIRDataModule(os.path.join(dataPath1, 'ghana_imerg_2011_2020_oct.h5'), \
