...
class IRDataset(Dataset):
    def __init__(self, fPath, start_date, end_date, in_seq_length, out_seq_length, IR_mean, IR_std):
        ...
        self.imgs = (self.imgs - IR_mean)/IR_std

        self.imgs = self.imgs[:, :, 1:-2]



    def __len__(self):
        return self.imgs.shape[0]-self.in_seq_length-self.out_seq_length
...
if __name__=='__main__':
    ...
    import os
    dataPath = "/home/cc/projects/nowcasting/data/IR/"
    fname = 'imerg_202007010000_202007312345.h5'
